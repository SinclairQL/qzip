...
all:
	...
	@echo 'convex, cray, cray3, dec_osf1, dnix, hpux, isc, linux, qdos,'
	@echo 'minix, next, next10, scodos, sun, sun_gcc, sysv, sysv_386,'
	@echo 'sysv_old, ultrix, xenix, xos, zilog.'
	@echo 'See the files install.txt and zip.txt for more information.'
	@echo ''
...
# Sinclair QL QDOS system with SMALL_MEM option
qdos:
	$(MAKE) zips CFLAGS="-O -fno-builtin -DSYSV -DTERMIO -DSMALL_MEM -DQDOS" \
	  CPP=qdos-cpp CC=qdos-gcc BIND=qdos-gcc LFLAGS2=""
